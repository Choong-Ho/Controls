...
namespace MVVM
{
    public interface IMessageBoxWindow
    {
        ...
        MessageBoxResult ShowQuestion(string messageBoxText, MessageBoxButton button = MessageBoxButton.YesNo, MessageBoxResult defaultResult = MessageBoxResult.None);
        ...
        MessageBoxResult Show(string messageBoxText, string caption = "", MessageBoxButton button = MessageBoxButton.OK, MessageBoxImage icon = MessageBoxImage.None, MessageBoxResult defaultResult = MessageBoxResult.None);
